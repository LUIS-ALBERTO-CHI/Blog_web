		...
		public async Task<int> SaveAsync(FarmGeneralInformationModel model)
		{
			try
			{
				...
				entity.PostalCode = await repositorySession
					...
					.GetAsync(model.PostalCodeId); //TODO: ?? throw ReferenceException https://dev.azure.com/fwaeu/BlogWeb/_workitems/edit/7139/

				entity.MainActivity = await repositorySession
					.Create<FarmActivityEntityRepository>()
					.GetAsync(model.MainActivityId); //TODO: ?? throw ReferenceException https://dev.azure.com/fwaeu/BlogWeb/_workitems/edit/7139/
