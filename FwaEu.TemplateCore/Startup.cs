...
using FwaEu.TemplateCore.Application;
...
using FwaEu.TemplateCore.FarmManager.Photo;
using FwaEu.Fwamework.Application;
using FwaEu.TemplateCore.Html;
...
using FwaEu.TemplateCore.AssemblyProvider;
