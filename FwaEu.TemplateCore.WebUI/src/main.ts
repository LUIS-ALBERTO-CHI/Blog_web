...
import { ApplicationModule } from "@/TemplateCore/application-module";
...
import { ApplicationUsersModule } from "@/TemplateCore/Users/users-module";
import { ApplicationCultureModule } from "@/TemplateCore/Culture/culture-module";
import { FarmManagerModule } from "@/TemplateCore/FarmManager/farm-manager-module";
import { FarmManagerReportModule } from "@/TemplateCore/FarmManager/Reports/farm-manager-report-module";
...
import { ContextViewModule } from "@/TemplateCore/ViewContext/view-context-module";
import AzureAdAuthenticationHandler from "@/Modules/AzureADAuthentication/Services/azure-ad-authentication-handler";
import { AzureADAuthenticationModule } from "@/Modules/AzureADAuthentication/azure-ad-authentication-module";
...
const application = new Application(App)
	...
	.useModule(new AzureADAuthenticationModule())
	...
	.useModule(new FarmManagerModule())
	.useModule(new FarmManagerReportModule())

	.useModule(new CurrenciesModule())
