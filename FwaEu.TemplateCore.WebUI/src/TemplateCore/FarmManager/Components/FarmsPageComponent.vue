...
<script>
	...
	import FarmsService from '@/TemplateCore/FarmManager/Services/farms-service';
	import { FarmCategorySizeDataSourceOptions } from "@/TemplateCore/FarmManager/Services/farm-category-sizes-master-data-service";

	import DataGridDataSourceFactory from "@UILibrary/Modules/MasterData/Services/data-grid-data-source-factory";
	import { FarmPostalCodeDataSourceOptions } from "@/TemplateCore/FarmManager/Services/farm-postal-code-master-data-service";
	import { FarmActivitiesDataSourceOptions } from "@/TemplateCore/FarmManager/Services/farm-activities-master-data-service";
	import { hasPermissionAsync } from "@/Fwamework/Permissions/Services/current-user-permissions-service";
	import { CanSaveFarms } from "@/TemplateCore/FarmManager/farms-permissions";
	import { UsersDataSourceOptions } from "@/Modules/UserMasterData/Services/users-master-data-service";
	import ViewContextService from '@/TemplateCore/ViewContext/Services/view-context-service';
	...
	export default {
		...
		created: showLoadingPanel(async function () {
			await loadMessagesAsync(this, import.meta.glob('@/TemplateCore/FarmManager/Components/Content/farms-messages.*.json'));
