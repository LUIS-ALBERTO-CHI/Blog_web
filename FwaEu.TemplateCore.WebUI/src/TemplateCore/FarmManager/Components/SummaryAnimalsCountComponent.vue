<template>
	<box :title="$t('animals')" :menu-items="menuButtons">
		<!-- TODO: Display the quantity of different types of animals https://dev.azure.com/fwaeu/TemplateCore/_workitems/edit/4931-->
...
<script>
	...
	import { FarmAnimalSpeciesDataSourceOptions } from "@/TemplateCore/FarmManager/Services/farm-animal-species-master-data-service";
	...
	export default {
		...
		async created() {
			await loadMessagesAsync(this, import.meta.glob('@/TemplateCore/FarmManager/Components/Content/summary-animals-count-messages.*.json'));
