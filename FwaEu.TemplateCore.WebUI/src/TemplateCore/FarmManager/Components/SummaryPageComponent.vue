	...
	<page-container type="summary" v-if="animalCountDataSource && farmDetails">
		<toolbar :menu-items="menuItems" :menu-options="{forceMenuMode: true}">
			<div>
				...
				<!--TODO https://dev.azure.com/fwaeu/TemplateCore/_workitems/edit/5007-->
...
<script>
	...
	import GeneralInformation from "@/TemplateCore/FarmManager/Components/SummaryGeneralInformationComponent.vue";
	import { AsyncLazy } from '@/Fwamework/Core/Services/lazy-load';
	import AnimalCount from "@/TemplateCore/FarmManager/Components/SummaryAnimalsCountComponent.vue";
	...
	import { CanDeleteFarms } from "@/TemplateCore/FarmManager/farms-permissions";
	import FarmGeneralInformationService from "@/TemplateCore/FarmManager/Services/farm-general-information-service";
	import FarmAnimalsCountService from "@/TemplateCore/FarmManager/Services/farm-animals-count-service";
	...
	export default {
		...
		created: showLoadingPanel(async function () {
			await loadMessagesAsync(this, import.meta.glob('@/TemplateCore/FarmManager/Components/Content/summary-messages.*.json'));
