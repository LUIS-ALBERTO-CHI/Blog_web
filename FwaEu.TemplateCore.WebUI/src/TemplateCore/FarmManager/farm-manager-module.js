...
import FarmTownConfiguration from '@/TemplateCore/FarmManager/Services/farm-town-configuration';
import FarmTownPostalCodeConfiguration from '@/TemplateCore/FarmManager/Services/farm-postal-code-configuration';
import FarmtActivityConfiguration from '@/TemplateCore/FarmManager/Services/farm-activity-configuration';
import FarmtAnimalSpeciesConfiguration from '@/TemplateCore/FarmManager/Services/farm-animal-species-configuration';
