...
import { CanAdministrateFarmMasterData } from '@/TemplateCore/FarmManager/farms-permissions';
...
class FarmTownConfiguration extends AbstractConfiguration {
	...
	async loadMessagesAsync(component) {
		await loadMessagesAsync(component, import.meta.glob('@/TemplateCore/FarmManager/Content/farm-town-messages.*.json'));
    }
	...
	async onColumnsCreatingAsync(component, columns) {
		...
		//TODO: Issues when creating new values because required culture client side is different from required culture server side https://dev.azure.com/fwaeu/TemplateCore/_workitems/edit/6961 
	}
}
