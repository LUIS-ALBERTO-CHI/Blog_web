...
<script>
	...
	const DefaultPageLayout = defineAsyncComponent(() => import(`./BlogWeb/Components/Layouts/${applicationLayout}.vue`));
...
<style lang="scss" src="@/BlogWeb/Content/application-styles.scss" />