const GeneralInformationPage = () => import("@/BlogWeb/FarmManager/Components/GeneralInformationPageComponent.vue");
const FarmsPage = () => import("@/BlogWeb/FarmManager/Components/FarmsPageComponent.vue");
const SummaryPage = () => import("@/BlogWeb/FarmManager/Components/SummaryPageComponent.vue");
const AnimalsQuantitiesPage = () => import("@/BlogWeb/FarmManager/Components/AnimalsQuantitiesModificationPageComponent.vue");
import { CheckOperation } from "@/Fwamework/Permissions/Services/current-user-permissions-service";
import { CanAccessToFarmManager, CanSaveFarms, CanDeleteFarms } from "@/BlogWeb/FarmManager/farms-permissions";
