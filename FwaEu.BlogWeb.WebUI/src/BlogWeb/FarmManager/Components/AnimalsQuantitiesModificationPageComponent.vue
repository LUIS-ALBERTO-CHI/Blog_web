...
<script>
	...
	import FarmAnimalsCountService from "@/BlogWeb/FarmManager/Services/farm-animals-count-service.js";
	...
	export default {
		...
		created: showLoadingPanel(async function () {
			await loadMessagesAsync(this, import.meta.glob('@/BlogWeb/FarmManager/Components/Content/animal-quantities-messages.*.json'));
